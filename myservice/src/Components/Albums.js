...
export class Albums extends Component {
    ...
    async getList () {
        const url ='https://jsonplaceholder.typicode.com/users/'+this.props.item+'/albums';
            ...
            <div>
                ...
                <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
                  <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                    <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Todo Item</h2>
                    <h1 class="md:text-3xl text-2xl font-medium title-font text-gray-900">{item.title}</h1>
                  </div>
